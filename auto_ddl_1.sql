...
CREATE SEQUENCE sz_azon_azon_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
azon int primary key NOT NULL DEFAULT nextval('sz_azon_azon_seq')
megnevezes text default '',
marka text,
leiras text
);
...
insert into sz_automarka (nev) values ('audi');
